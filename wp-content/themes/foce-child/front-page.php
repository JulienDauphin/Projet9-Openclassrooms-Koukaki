...
<main id="primary" class="site-main">
    ...
    <section id="place">
        <div>
            ...
            <div id="nuage">
                <img class="nuage-grand" src="http://localhost/koukaki_final/wp-content/uploads/2023/03/big_cloud.png"
                    alt="Gros nuage">
                <img class="nuage-petit"
                    src="http://localhost/koukaki_final/wp-content/uploads/2023/03/little_cloud.png" alt="Petit nuage">
            </div>
        </div>
        </section>
    </section>
