            ...
            <nav id="site-navigation" class="main-navigation">
                ...
                <div class="opened-menu">
                    <div class="images-menu">
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri() . '/images/chat-orange.png'; ?>"
                            alt="Chat orange" class="chat orange">
                        <img src="<?php echo get_stylesheet_directory_uri() . '/images/chat-noir.png'; ?>"
                            alt="Chat noir" class="chat noir">
                        <img src="<?php echo get_stylesheet_directory_uri() . '/images/chat-bleu.png'; ?>"
